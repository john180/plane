  ...
  return (
    <>
      ...
      {error ? (
        <EmptyState
          image={emptyModule}
          title={t("module_detail.empty_state.not_found.title")}
          description={t("module_detail.empty_state.not_found.description")}
          primaryButton={{
            text: t("module_detail.empty_state.not_found.primary_button"),
